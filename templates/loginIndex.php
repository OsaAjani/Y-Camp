...
<div class="colored-background">
	<div class="container-fluid">
		<div class="row">
			<form class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-4 connexion-form" action="<?php echo $this->generateUrl('login', 'index'); ?>" method="POST">
				<h2>Connexion - <?php echo WEBSITE_TITLE ?></h2>
