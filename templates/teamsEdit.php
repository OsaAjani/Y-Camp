<div id="teams-edit" class="tile">
	...
	<form class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3 add-form ajax-form" method="POST" action="<?php secho($this->generateUrl('teams', 'update', [$_SESSION['csrf']])); ?>" target="<?php secho($this->generateUrl('teams', 'show', [$team['id']])); ?>" target-id="teams-show">
