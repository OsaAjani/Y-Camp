<?php
	...
	*/
	...
	//On définit les chemins
        define('PWD', '/var/www/html/y-camp/'); //On défini le chemin de base du site
	define('HTTP_PWD', (isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . (isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : 'localhost') . '/y-camp/'); //On défini l'adresse url du site
	...
	//Réglages divers
	define('WEBSITE_TITLE', 'Y-Camp'); //Le titre du site
	define('WEBSITE_DESCRIPTION', ''); //Description du site
	define('WEBSITE_KEYWORDS', ''); //Mots clefs du site
	define('WEBSITE_AUTHOR', 'Ajani & Vaenyc'); //Auteur du site
	...
	define('DATABASE_NAME', 'y_camp'); //Nom de la bdd
